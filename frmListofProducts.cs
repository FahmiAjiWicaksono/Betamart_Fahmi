...
namespace BetamartFahmi
{
    public partial class frmListofProducts : Form
    {
        ...
        public void refresh()
        {
            sql = "SELECT PROCODE as [ProductCode], (PRONAME + ' ' + PRODESC) AS [Product],CATEGORY AS [Category], (PROPRICE) AS [Price],PROQTY AS [Note] FROM  tblProductInfo";
        ...
        private void TXTSEARCH_TextChanged(object sender, EventArgs e)
        {
            ...
            sql = "SELECT PROCODE as [ProductCode], (PRONAME + ' ' + PRODESC) AS [Product],CATEGORY AS [Category], (PROPRICE) AS [Price],PROQTY  AS [Note] FROM  tblProductInfo WHERE  (PROCODE + ' ' + PRONAME + ' ' + PRODESC  + ' ' + CATEGORY)  LIKE '%" + TXTSEARCH.Text + "%'";
            config.Load_DTG(sql, DTGLIST);
